...
Set-UserEnvVar 'DOTNET_CLI_HOME' "$env:XDG_DATA_HOME\dotnet"
Set-UserEnvVar 'NUGET_PACKGES' "$env:XDG_CACHE_HOME\nuget-packages"
Set-UserEnvVar 'OMNISHARPHOME' "$env:XDG_CONFIG_HOME\omnisharp"
Set-UserEnvVar 'NODE_REPL_HISTORY' "$env:XDG_STATE_HOME\node\history"
Set-UserEnvVar 'PYTHON_HISTORY' "$env:XDG_STATE_HOME\python\history"
Set-UserEnvVar 'MINIKUBE_HOME' "$env:XDG_DATA_HOME\minikube"
Set-UserEnvVar 'KUBECONFIG' "$env:XDG_CONFIG_HOME\kube"
Set-UserEnvVar 'KUBECACHEDIR' "$env:XDG_CACHE_HOME\kube"
