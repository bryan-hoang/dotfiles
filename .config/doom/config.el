...
(setq user-full-name "Bryan Hoang"
      user-mail-address "bryan@bryanhoang.dev")
...
;; accept. For example:
;;
(setq doom-font (font-spec :family "BerkeleyMonoVariable Nerd Font Mono" :size 12))
;;
...
; Disable exit prompt. It started annoying me while testing config changes.
